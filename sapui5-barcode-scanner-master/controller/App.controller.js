		...
		_initQuagga: function(oTarget){
			...
			if(!this._bQuaggaEventHandlersAttached){
				...
				Quagga.onDetected(function(result) {
					...
					this.getView().byId("scannedCode0").setValue(result.codeResult.decodedCodes[0].code);
					this.getView().byId("scannedCode1").setValue(result.codeResult.decodedCodes[1].code);
					this.getView().byId("scannedCode2").setValue(result.codeResult.decodedCodes[2].code);
					this.getView().byId("scannedCode3").setValue(result.codeResult.decodedCodes[3].code);
					// Close dialog
					this._oScanDialog.close();
				}.bind(this));
